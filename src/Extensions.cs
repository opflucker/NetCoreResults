...
public static partial class ResultExtensions
{
    ...
    public static Result<TError2> MapFailure<TError, TError2>(this Result<TError> result, Func<TError, TError2> func)
        => result.Map<Result<TError2>>(() => Result.Success(), error => func(error));
    ...
    public static Result<TData2, TError2> Map<TData, TError, TData2, TError2>(this Result<TData, TError> result, Func<TData, TData2> successFunc, Func<TError, TError2> failureFunc)
        => result.Map<Result<TData2, TError2>>(data => successFunc(data), error => failureFunc(error));
    ...
    public static Result<TData2, TError> MapSuccess<TData, TError, TData2>(this Result<TData, TError> result, Func<TData, Result<TData2, TError>> func)
        => result.Map(func, error => error);
    public static Result<TData2, TError> MapSuccess<TData, TError, TData2>(this Result<TData, TError> result, Func<TData, TData2> func)
        => result.Map<Result<TData2, TError>>(data => func(data), (error) => error);
    ...
    public static Result<TData, TError2> MapFailure<TData, TError, TError2>(this Result<TData, TError> result, Func<TError, TError2> func)
        => result.Map<Result<TData, TError2>>(data => data, error => func(error));
